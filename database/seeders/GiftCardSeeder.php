...
class GiftCardSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $cards = [
            ...
            ['name' => 'Steam $50 Gift Card', 'slug' => 'steam-50-usd', 'denomination_usd' => 50, 'denomination_bdt' => 6000, 'price_bdt' => 6900, 'category_id' => $usdCategory->id, 'badge_text' => null, 'sort_order' => 4],
            ['name' => 'Steam $100 Gift Card', 'slug' => 'steam-100-usd', 'denomination_usd' => 100, 'denomination_bdt' => 12000, 'price_bdt' => 13500, 'category_id' => $usdCategory->id, 'badge_text' => null, 'sort_order' => 5],
            ['name' => 'Steam BDT 500 Gift Card', 'slug' => 'steam-500-bdt', 'denomination_usd' => 4.20, 'denomination_bdt' => 500, 'price_bdt' => 600, 'category_id' => $bdtCategory->id, 'badge_text' => null, 'sort_order' => 6],
        ];
        ...
        foreach ($cards as $cardData) {
            ...
            // Only seed codes if no codes exist
            if ($card->codes()->count() === 0) {
                for ($i = 1; $i <= 5; $i++) {
