<x-guest-layout title="Reset Password">
    <x-auth-shell heading="Set a new password" subheading="Choose something you have not used here before.">
        ...
        <form method="POST" action="{{ route('password.store') }}" class="space-y-5"
            ...
            <div>
                <x-auth-password label="New password" autocomplete="new-password"
        ...
        <p class="mt-6 text-center text-caption text-ink-low">
            <a href="{{ route('login') }}" class="font-semibold text-accent-hover hover:underline">Back to sign in</a>
        </p>
    </x-auth-shell>
</x-guest-layout>
