...
@if($chat->enabled())
    ...
    <div class="rounded-card border border-surface-3 bg-surface-1 p-4"
        ...
        <p class="mb-2.5 text-caption font-semibold text-ink-hi">Prefer to order by chat?</p>
        ...
        <div class="flex flex-col gap-2 sm:flex-row">
            ...
            <a href="{{ $chat->whatsappUrl($fallbackMessage) }}"
               ...
               class="flex min-h-[44px] items-center justify-center gap-2 rounded-control border border-whatsapp px-4 text-body font-semibold text-whatsapp transition-colors hover:bg-whatsapp/10 sm:flex-1">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="flex-shrink-0">
            ...
            <a href="{{ $chat->messengerUrl($fallbackRef) }}"
               ...
               class="flex min-h-[44px] items-center justify-center gap-2 rounded-control border border-messenger px-4 text-body font-semibold text-messenger transition-colors hover:bg-messenger/10 sm:flex-1">
                <svg width="18" height="18" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true" class="flex-shrink-0">
